...
st.set_page_config(
    page_title="Le Cockpit - Onboarding",
    page_icon="🚀",
    layout="centered"
)
...
TOOLS = [
    ...
    },
    {
        ...
        "steps": [
            ...
            "Tapez la commande d'installation fournie par votre formateur.",
...
with col2:
    if st.button("🆘 Besoin d'aide ?"):
        st.info("Contactez votre formateur à : formateur@example.com")
...
for tool in TOOLS:
    with st.container():
        # Utilisation de colonnes pour simuler la carte
        st.markdown(f"""
            <div class="tool-card">
