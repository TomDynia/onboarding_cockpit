...
st.markdown("""
    <style>
    /* Couleurs extraites du logo DYNIA */
    :root {
        --brand-deep: #0c2461;
...
with col_logo:
    # On vérifie si le fichier logo.png existe pour éviter une erreur
    if os.path.exists("logo.png"):
        st.image("logo.png", use_container_width=True)
    else:
        # Fallback si le logo n'est pas encore sur GitHub
...
st.markdown(f"""
    <div style="text-align: center; padding: 40px 20px; background-color: #f1f5f9; border-radius: 1.5rem;">
        ...
        <p style="color: #475569;">Thomas est à votre disposition pour vous aider à finaliser votre Cockpit.</p>
        <br>
...
if progress == 1.0:
    st.balloons()
    st.success("🎉 Félicitations ! Votre Cockpit est prêt. Vous pouvez maintenant commencer à créer !")